...
class Game:
    ...
    def __hash__(self): return hash(tuple(self.term, self.doc_freq))
...
class ConnectFour(TicTacToe):
    ...
    def display(self, state):
        ...
        for y in range(self.v, 0, -1):
            for x in range(1, self.h + 1):
                if board.get((x, y)) == 'X':  # Color rojo
                    print '\033[91m' + 'X' + '\033[m',
                if board.get((x, y)) == 'O':  # Color azul
                    print '\033[34m' + 'O' + '\033[m',
